...
import { UpgradePlanCard } from '@components/ui/cards'
...
type HTMLDivOrElementRef = MutableRef<HTMLDivElement | HTMLElement>
                                ...
                                >
                                    ...
                                    <Box style={{ height: '100%', maxHeight: 'calc(100vh - 250px)', overflowX: 'hidden' }}>
                                        <Box sx={{ p: 2 }}>
                                            ...
                                            >
                                                <ListItemButton
                                                    sx={{ borderRadius: `${theme.custom.borderRadius}px` }}
