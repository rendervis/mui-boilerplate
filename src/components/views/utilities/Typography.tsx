...
// project imports
import { SubCard, MainCard, SecondaryAction } from '@components/ui/cards';
...
const Typography = () => {
    ...
    return (
        <MainCard
            ...
            secondary={<SecondaryAction link="https://next.material-ui.com/system/typography/" title="Typography" />}
        >
